...
VALUES ('Ruud','Rooi','de','ruudderooi@gmail.com','ruudderooi@gmail.com','Welkom123!',
...
Values ('Robert','Hogedoorn',null,'rh@gmail.com','rh@gmail.com','Welkom123!',(Select schoolid from school where schoolnaam = 'Avans Hogeschool' LIMIT 1) ,(SELECT OpleidingID FROM selectieopleiding WHERE Naamopleiding = 'Informatica' and Voltijd_deeltijd = 'Voltijd' LIMIT 1),'2019-08-31', 'Oosterhoutseweg',1212, '4940QW', 'Oosterhout', '1997-07-12');
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
VALUES ('Mariska','Raamsdonk',null,'MariskaRaamsdonk@gmail.com','MariskaRaamsdonk@gmail.com','Welkom123!',(Select schoolid from school where schoolnaam = 'Avans Hogeschool' LIMIT 1) ,(SELECT OpleidingID FROM selectieopleiding WHERE Naamopleiding = 'Informatica' and Voltijd_deeltijd = 'Voltijd' LIMIT 1),'2019-08-31', 'Hertogshoef',234, '4951ZZ', 'Raamsdonksveer', '1980-12-22');
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
VALUES ('Jolanda','Hooijdonk','van','JolandavanHooijdonk@gmail.com','JolandavanHooijdonk@gmail.com','Welkom123!',(Select schoolid from school where schoolnaam = 'Hogeschool Rotterdam' LIMIT 1) ,(SELECT OpleidingID FROM selectieopleiding WHERE Naamopleiding = 'Informatica' and Voltijd_deeltijd = 'Voltijd' LIMIT 1),'2019-08-31', 'Rivierdijk',12, '3372RD', 'Hardinxveld-Giessendam', '1976-01-24');
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
...
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
VALUES ('Nico','Jong','de','NicodeJong@gmail.com','NicoDeJong@gmail.com','Welkom123!',(Select schoolid from school where schoolnaam = 'Avans Hogeschool' LIMIT 1) ,(SELECT OpleidingID FROM selectieopleiding WHERE Naamopleiding = 'Informatica' and Voltijd_deeltijd = 'Voltijd' LIMIT 1),'2019-08-31', 'Overweg',12, '1234IJ', 'Rijen', '2001-02-17');
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
VALUES ('Donny','Muller',null,'dmuller@gmail.com','dmuller@gmail.com','Welkom123!',(Select schoolid from school where schoolnaam = 'Avans Hogeschool' LIMIT 1) ,(SELECT OpleidingID FROM selectieopleiding WHERE Naamopleiding = 'Informatica' and Voltijd_deeltijd = 'Voltijd' LIMIT 1),'2019-08-31', 'Duitsstraat',66, '1333DD', 'Oosterhout', '1972-09-13');
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
VALUES ('Mik','Beer','de','MikdeBeer@gmail.com','MikdeBeer@gmail.com','Welkom123!',(Select schoolid from school where schoolnaam = 'Avans Hogeschool' LIMIT 1) ,(SELECT OpleidingID FROM selectieopleiding WHERE Naamopleiding = 'Informatica' and Voltijd_deeltijd = 'Voltijd' LIMIT 1),'2019-08-31', 'Dirk-Jan laan',1233, '2234RD', 'Breda','1989-03-15');
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
...
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
VALUES ('Linda','Heijst','van','LindaVanHeijst@gmail.com','LindaVanHeijst@gmail.com','Welkom123!',(Select schoolid from school where schoolnaam = 'Avans Hogeschool' LIMIT 1) ,(SELECT OpleidingID FROM selectieopleiding WHERE Naamopleiding = 'Informatica' and Voltijd_deeltijd = 'Voltijd' LIMIT 1),'2019-08-31', 'Adolf Rolfstraat',33, '4233DE', 'Lage-Zwaluwe','1995-03-02');
INSERT INTO gebruiker(Voornaam, Achternaam, Tussenvoegsel,Gebruikersnaam, Email, Wachtwoord, School, Opleiding, Startdatumopleiding, Straat,Huisnummer,Postcode,Woonplaats,Geboortedatum) 
